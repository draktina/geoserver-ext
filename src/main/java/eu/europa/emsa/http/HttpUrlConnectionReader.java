...
public class HttpUrlConnectionReader
{
    ...
    public HttpUrlConnectionReader()
    {
        try
        {
            String myUrl = "http://qimdate:7035/imdate-dist-surv/getAlerts";
            ...
            throws Exception
    {
        ...
        try
        {
            ...
            HttpUrlBuilder urlBuilder = new HttpUrlBuilder(url);
            urlBuilder.put("user", "CARREPH1");
            urlBuilder.put("project", "default");
            urlBuilder.put("startTime", "2015-01-13T12:21:56Z");
            urlBuilder.put("endTime", "2015-01-14T12:21:56Z");
